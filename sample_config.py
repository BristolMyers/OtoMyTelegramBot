...
class Config(object):
    ...
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "OtoMyTelegramBot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/OtoMyTelegramBot")
    APP_DESCRIPTION = os.environ.get("APP_DESCRIPTION", "created using https://telegram.dog/OtoMyTelegramBot")
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @BristolMyers")
